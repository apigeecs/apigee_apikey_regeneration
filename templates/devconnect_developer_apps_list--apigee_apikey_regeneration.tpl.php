...
<?php if ($application_count): ?>
  ...
  <?php foreach ($applications as $app): ?>
    ...
    <?php endif; // delete developer apps ?>
                <?php if (user_access("edit developer apps")): ?>
                    <li class="hidden-xs apigee-modal-link-regenerate-key"><a href="<?php print base_path() . $app['regenerate_url']; ?>" data-toggle="modal" data-target="#regenerate-keys-<?php print $app['id']; ?>"><?php print t('Regenerate Keys'); ?></a></li>
                    <li class="visible-xs apigee-modal-link-regenerate-key"><a href="<?php print base_path() . $app['regenerate_url']; ?>" data-toggle="modal" data-target="#regenerate-keys-<?php print $app['id']; ?>"><?php print t('Regenerate Keys'); ?></a></li>
                <?php endif; // edit developer apps ?>
            </ul>
    <?php if (user_access('edit developer apps')): ?>
    <!-- Edit Modal -->
        ...
        <!-- Edit Modal -->
        <div class="modal fade" id="regenerate-keys-<?php print $app['id']; ?>" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title" id="edit-<?php print $app['id']; ?>-title"><?php print t('Regenerate Keys for @name', array('@name' => $app['app_name'])); ?></h4>
                    </div>
                    <div class="modal-body"></div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
